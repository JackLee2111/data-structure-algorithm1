...
int main()
{
    ...
    //  ASCII测试入口
    /*
    infile.open("./final-data/1-1.in", ios::in); // final-data/1-1.in  test_a1.in
    outfile.open("./final-data/out.txt", ios::in);
    if (!infile.is_open())
    ...
    //  utf-8测试入口
    infile.open("./final-data/2-3.in", ios::in); // final-data/1-1.in  test_a1.in
    outfile.open("./final-data/out.txt", ios::in);
