...
int main()
{
    //输入函数表达式
    string fun1;
    cout << "please input your function: (example:f(X2)=3+4*X2)" << endl;
    getline(cin, fun1);
    ...
    //在表达式中找到变量
    string variable = get_variable(fun1);
    cout << variable << endl;
    ...
    //求值
    cout << cal_arithmetic(to_postfix(function)) << endl;
